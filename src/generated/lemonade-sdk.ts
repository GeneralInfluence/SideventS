...
export type BroadcastRecordingStatus =
  | 'notRecording'
  | 'recorded'
  | 'recording';
...
export type DeliveryOptionWaiveType =
  | 'any'
  | 'product'
  | 'store';
...
export type Event = {
  ...
  hide_inNEXT_PUBLIC_action: Maybe<Scalars['Boolean']['output']>;
...
export type EventCohostRequestState =
  | 'ACCEPTED'
  | 'DECLINED'
  | 'PENDING';
...
export type EventInput = {
  ...
  hide_inNEXT_PUBLIC_action: InputMaybe<Scalars['Boolean']['input']>;
...
export type EventJoinRequestState =
  | 'approved'
  | 'declined'
  | 'pending';
...
export type EventbriteEventOrder =
  | 'CREATED_ASC'
  | 'CREATED_DESC';
...
export type FeatureCode =
  ...
  | 'ManageSpace'
  | 'ManageSpaceEvent'
  | 'ManageSpaceEventRequest'
  | 'ManageSpaceMembership'
  | 'ManageSpaceNewsletter'
  | 'ManageSpaceTag'
...
export type FrequentQuestionType =
  | 'event'
  | 'poap'
  | 'user';
...
export type GetEventQuestionInputSort =
  | '_id'
  | 'likes';
...
export type GetRoomCredentialsInputRole =
  | 'PUBLISHER'
  | 'SUBSCRIBER';
...
export type LemonheadSupportDataType =
  | 'color';
...
export type ListEventGuestsSortBy =
  | 'approval_status'
  | 'email'
  | 'name'
  | 'register_time';
...
export type NewPaymentProvider =
  | 'safe'
  | 'stripe';

export type NewPaymentState =
  | 'await_capture'
  | 'cancelled'
  | 'created'
  | 'failed'
...
export type NotificationType =
  ...
  | 'event_donation'
  | 'event_invite'
  | 'event_inNEXT_PUBLIC_attending'
  | 'event_inNEXT_PUBLIC_verify_accept_request'
  | 'event_inNEXT_PUBLIC_verify_request'
...
export type SendgridCreditResetFrequency =
  | 'daily'
  | 'monthly'
  | 'weekly';

export type SendgridCreditType =
  | 'nonrecurring'
  | 'recurring'
  | 'unlimited';
...
export type SiteFooterScriptStrategy =
  | 'AfterInteractive'
  | 'BeforeInteractive'
  | 'LazyOnload';
...
export type SiteOnboardingStepName =
  | 'About'
  | 'AdultCheck'
  | 'Biography'
  | 'ConditionsCheck'
...
export type SpaceEventRequestState =
  | 'approved'
  | 'declined'
  | 'pending';
...
export type StoreOrderItemState =
  | 'accepted'
  | 'declined'
  | 'pending';
...
export type StorePromotionType =
  | 'event';
...
export type StripeAccountCapabilityDisplayPreferencePreference =
  | 'none'
  | 'off'
  | 'on';

export type StripeAccountCapabilityDisplayPreferenceValue =
  | 'off'
  | 'on';

export type StripeCapabilityType =
  | 'apple_pay'
  | 'card'
  | 'google_pay';
...
export type UserDiscoverySwipeDecision =
  | 'accept'
  | 'decline';

export type UserDiscoverySwipeSource =
  | 'discovery'
  | 'live';

export type UserDiscoverySwipeState =
  | 'declined'
  | 'matched'
  | 'pending'
  | 'undecided';
...
export type UserFriendshipType =
  | 'crew'
  | 'tribe';
...
export type UserPaymentVerificationState =
  | 'completed'
  | 'declined'
  | 'pending';
